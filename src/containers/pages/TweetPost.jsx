  ...
  return (
    <Layout>
      ...
      <div className="w-full flex flex-col py-3 px-9 ml-72">
        ...
        <textarea className="bg-transparent p-3 resize-none border border-gray-400 rounded-lg" placeholder="Write your description" autoFocus rows='5' maxLength='400' required></textarea>
